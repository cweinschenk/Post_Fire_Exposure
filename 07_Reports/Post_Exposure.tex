...
\begin{table}[!ht]
	...
	\begin{tabular}{llll}
		...
		\midrule
		Mattress Topper  & 75 x 58 x 4  & Polyurethane Foam  &  6.85     \\
		Mattress     & 79 X 59 x12  & 90~\% Polyurethane foam, 10~\% Blended rayon \& polyester   & 30.1  \\
		<row\_1\_content>     & <row\_2\_content>  & <row\_3\_content>     & <row\_4\_content>     \\
		<row\_1\_content>     & <row\_2\_content>  & <row\_3\_content>     & <row\_4\_content>     \\	
